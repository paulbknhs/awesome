...
keys.globalkeys = gears.table.join(
	...
	end, { description = "start the webbrowser", group = "launcher" }),
	----------------------------------------------------------------------
	-- launch chrome
	...
	end, { description = "start the IDE", group = "launcher" }),
	----------------------------------------------------------------------
	awful.key({ modkey, "Shift" }, "v", function()
		awful.spawn("vlc", false)
	end, { description = "start the mediaplayer", group = "launcher" }),
	----------------------------------------------------------------------
	awful.key({ modkey }, "e", function()
		awful.spawn("exec nemo", false)
	end, { description = "start the mediaplayer", group = "launcher" }),
	----------------------------------------------------------------------
	-- =========================================
	-- FUNCTION KEYS
	...
	awful.key({ modkey }, "g", function()
		awful.spawn("r_games", false)
	end, { description = "start game manager", group = "launcher" }),
	----------------------------------------------------------------------
	-- Start app as root
	awful.key({ modkey, "Shift" }, "x", function()
		awful.spawn("r_asroot", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey }, "x", function()
		awful.spawn("r_apps", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey }, "p", function()
		awful.spawn("r_power", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey }, "b", function()
		awful.spawn("r_bright", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn("r_quick", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn("r_screen", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey }, "v", function()
		awful.spawn("r_vol", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	awful.key({ modkey }, "m", function()
		awful.spawn("r_music", false)
	end, { description = "", group = "launcher" }),
	----------------------------------------------------------------------
	-------------------------------------------------
	...
	awful.key({}, "XF86MonBrightnessUp", function()
		awful.spawn("blight set +10", false)
	...
	----------------------------------------------------------------------
	awful.key({}, "XF86AudioPerlay", function()
	...
	awful.key({ modkey }, "Escape", function()
		...
		awesome.spawn("/home/paul/.config/rofi/powermenu/type-4/powermenu.sh")
